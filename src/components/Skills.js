...
const skills = [
    {id: 1, name: "OOP Design Patterns & Principles", value: "80", color: "color-1"},
    {id: 2, name: "C++", value: "75", color: "color-2"},
    {id: 3, name: "Qt", value: "80", color: "color-1"},
    {id: 4, name: "C#", value: "75", color: "color-3"},
    {id: 5, name: "Embedded Linux", value: "75", color: "color-1"},
    {id: 6, name: "HTML/CSS/Javascript", value: "75", color: "color-2"},
    {id: 7, name: "React", value: "75", color: "color-1"},
